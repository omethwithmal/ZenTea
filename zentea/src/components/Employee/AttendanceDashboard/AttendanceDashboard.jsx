...
const AttendanceDashboard = () => {
    ...
    const [attendanceData, setAttendanceData] = useState([
        { id: 1, name: "John Doe", eId: "E001", date: "2023-10-01", inTime: "09:00 AM", outTime: "05:00 PM", otTime: "01:00", department: "HR", status: "Present" },
        { id: 2, name: "Jane Smith", eId: "E002", date: "2023-10-01", inTime: "09:15 AM", outTime: "04:45 PM", otTime: "00:30", department: "IT", status: "Absent" },
        { id: 3, name: "Sam Wilson", eId: "E003", date: "2023-10-01", inTime: "08:45 AM", outTime: "06:00 PM", otTime: "02:00", department: "Finance", status: "Present" },
    ]);
    ...
    const generateCSV = () => {
        const csvRows = [];
        const headers = ["Name", "E ID", "Date", "In Time", "Out Time", "OT Time", "Department", "Status"];
                ...
                <table style={{
                    ...
                    <thead style={{
                        ...
                        <tr>
                            ...
                            <th style={{ padding: '10px', textAlign: 'left' }}>OT Time</th>
                    ...
                    <tbody>
                        {filteredData.map((item) => (
                            <tr key={item.id} style={{
                                ...
                                <td style={{ padding: '10px' }}>{item.otTime}</td>
                                <td style={{ padding: '10px' }}>{item.department}</td>
                                <td style={{ padding: '10px', color: item.status === "Present" ? 'green' : 'red' }}>
                                    {item.status}
                                </td>
